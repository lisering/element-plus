export const rightRichTextSponsors = [
  {
    ...
    url: 'https://www.misboot.com/?from=hicor-ui',
...
export const rightBigLogoSponsors = [
  {
    ...
    url: 'http://github.crmeb.net/u/Element?from=hicor-ui',
...
export const rightLogoSmallSponsors = [
  {
    ...
    url: 'https://wonderful-code.gitee.io/?from=hicor-ui',
...
export const leftCustomImgSponsors = [
  {
    ...
    url: 'https://js.design/?source=hicor-ui&plan=sy',
