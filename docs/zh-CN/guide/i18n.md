...
如果通过 CDN 使用 Hicor Ui ，那么你需要添加以下代码，以下是使用 unpkg 的示例

```html
<script src="//unpkg.com/hicor-ui/dist/locale/zh-cn"></script>
<script>
  app.use(HicorUi, {
...
[支持的语言列表](https://github.com/hicor-ui/hicor-ui/tree/dev/packages/locale/lang)
...
如果你需要使用其他的语言，欢迎贡献 [PR](https://github.com/hicor-ui/hicor-ui/pulls)，只需在[这里](https://github.com/hicor-ui/hicor-ui/tree/dev/packages/locale/lang)添加一个语言配置文件即可。
