...
[![HicorUi version badge](https://img.shiods.io/npm/v/hicor-ui.svg?style=flat-square)](https://www.npmjs.org/package/hicor-ui)

## 使用包管理器

**我们建议您使用包管理器（如 NPM、[Yarn](https://classic.yarnpkg.com/lang/en/) 或 [pnpm](https://pnpm.io/)）安装 Hicor Ui**，然后您就可以使用打包工具，例如 [Vite](https://vitejs.dev) 或 [webpack](https://webpack.js.org/)。

```shell
# 选择一个你喜欢的包管理器

# NPM
$ npm install hicor-ui --save
...
直接通过浏览器的 HTML 标签导入 Hicor Ui，然后就可以使用全局变量 `HicorUi` 了。
...
<head>
  <!-- Import style -->
  <link rel="stylesheet" href="//unpkg.com/hicor-ui/dist/index.css" />
  <!-- Import Vue 3 -->
  <script src="//unpkg.com/vue@3"></script>
  <!-- Import component library -->
  <script src="//unpkg.com/hicor-ui"></script>
</head>
```
...
<head>
  ...
  <link
    rel="stylesheet"
    href="//cdn.jsdelivr.net/npm/hicor-ui/dist/index.css"
  />
  <!-- Import Vue 3 -->
  <script src="//cdn.jsdelivr.net/npm/vue@3"></script>
  <!-- Import component library -->
  <script src="//cdn.jsdelivr.net/npm/hicor-ui"></script>
</head>
```
...
通过 CDN 的方式我们可以很容易地使用 Hicor Ui 写出一个 Hello world 页面。 [在线演示](https://codepen.io/iamkun/pen/YzWMaVr)
