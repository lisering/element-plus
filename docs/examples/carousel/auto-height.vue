<template>
  <div class="block text-center" style="height: 300px">
    ...
    <hc-carousel height="auto" autoplay>
      <hc-carousel-item style="height: 100px">
        <h3 class="small justify-center" text="2xl">height 100px</h3>
      </hc-carousel-item>
      <hc-carousel-item style="height: 200px">
        <h3 class="small justify-center" text="2xl">height 200px</h3>
      </hc-carousel-item>
      <hc-carousel-item style="height: 300px">
...
.hc-carousel__item:nth-child(2n) {
  background-color: #99a9bf;
}

.hc-carousel__item:nth-child(2n + 1) {
