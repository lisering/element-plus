...
import installStyle from '@hicor-ui/test-utils/style-plugin'
import {
  HcCheckbox as Checkbox,
  HcCheckboxGroup as CheckboxGroup,
...
import type { FormRules } from '@hicor-ui/components/form'
...
describe('Form', () => {
  ...
  it('label width', async () => {
    ...
    expect(findStyle(wrapper, '.hc-form-item__label').width).toBe('80px')
  })
  ...
  it('auto label width', async () => {
    ...
    const formItems = wrapper.findAll<HTMLElement>('.hc-form-item__content')
    ...
    const formItems1 = wrapper.findAll<HTMLElement>('.hc-form-item__content')
  ...
  it('form-item auto label width', async () => {
    ...
    const formItemLabels = wrapper.findAll<HTMLElement>('.hc-form-item__label')
    const formItemLabelWraps = wrapper.findAll<HTMLElement>(
      '.hc-form-item__label-wrap'
    )
  ...
  it('show message', async () => {
    ...
    expect(wrapper.find('.hc-form-item__error').exists()).toBe(false)
  })
  ...
  it('reset field', async () => {
    ...
    expect(wrapper.findAll('.hc-form-item__error')).toHaveLength(0)
    vi.useRealTimers()
  })
