...
describe('Badge', () => {
  test('has value', () => {
    ...
    expect(wrapper.find('.hc-badge__content').text()).toEqual('80')
  })
  ...
  test('is fixed', () => {
    ...
    expect(wrapper.find('.hc-badge__content.is-fixed').exists()).toBe(true)
    expect(wrapper.find('.hc-badge').text()).toBe(AXIOM)
  })
  ...
  test('max', async () => {
    ...
    expect(wrapper.find('.hc-badge__content').text()).toEqual('100+')
    badgeValue.value = 80
    await nextTick()
    expect(wrapper.find('.hc-badge__content').text()).toEqual('80')
  })
