...
import Row from '@hicor-ui/components/row'
import Col from '../src/col.vue'

describe('Col', () => {
  it('create', () => {
    const wrapper = mount(() => <Col />)
    expect(wrapper.classes()).toContain('hc-col')
  })

  it('span', () => {
    const wrapper = mount(() => <Col span={12} />)
    expect(wrapper.classes()).toContain('hc-col-12')
  })

  it('pull', () => {
    const wrapper = mount(() => <Col span={12} pull={3} />)
    expect(wrapper.classes()).toContain('hc-col-pull-3')
  })

  it('push', () => {
    const wrapper = mount(() => <Col span={12} push={3} />)
    expect(wrapper.classes()).toContain('hc-col-push-3')
  })
  ...
  it('responsive', () => {
    ...
    expect(colElmClass.includes('hc-col-sm-4')).toBe(true)
    expect(colElmClass.includes('hc-col-sm-4')).toBe(true)
    expect(colElmClass.includes('hc-col-sm-offset-2')).toBe(true)
    expect(colElmClass.includes('hc-col-lg-6')).toBe(true)
    expect(colElmClass.includes('hc-col-lg-offset-3')).toBe(true)
    expect(colElmClass.includes('hc-col-md-8')).toBe(true)
  })
})
...
describe('Row', () => {
  test('create', () => {
    ...
    expect(wrapper.classes()).toContain('hc-row')
  })
