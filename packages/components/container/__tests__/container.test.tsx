...
import { getCssVariable } from '@hicor-ui/test-utils/dom'
...
describe('Header', () => {
  test('create header', () => {
    ...
    expect(wrapper.classes()).toContain('hc-header')
  })

  test('header height', () => {
    const wrapper = mount(() => <Header height="100px" />)
    const vm = wrapper.vm
    expect(getCssVariable(vm.$el, '--hc-header-height')).toEqual('100px')
  })
})
...
describe('Aside', () => {
  test('aside create', () => {
    ...
    expect(wrapper.classes()).toContain('hc-aside')
  })

  test('aside width', () => {
    const wrapper = mount(() => <Aside width="200px" />)
    const vm = wrapper.vm
    expect(getCssVariable(vm.$el, '--hc-aside-width')).toEqual('200px')
  })
})
...
describe('Main', () => {
  test('main create', () => {
    ...
    expect(wrapper.classes()).toContain('hc-main')
  })
})
...
describe('Footer', () => {
  test('footer create', () => {
    ...
    expect(wrapper.classes()).toContain('hc-footer')
  })

  test('footer height', () => {
    const wrapper = mount(() => <Footer height="100px" />)
    const vm = wrapper.vm
    expect(getCssVariable(vm.$el, '--hc-footer-height')).toEqual('100px')
  })
})
