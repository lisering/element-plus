...
describe('Space.vue', () => {
  it('render test', async () => {
    ...
    expect(wrapper.find('.hc-space--vertical').exists()).toBe(true)
    expect(wrapper.find('.hc-space').attributes('style')).toContain(
      'flex-wrap: wrap'
    )
  })
  ...
  it('sizes', async () => {
    ...
    await nextTick()
    expect(wrapper.find('.hc-space__item').attributes('style')).toContain(
      'margin-right: 16px'
    )
