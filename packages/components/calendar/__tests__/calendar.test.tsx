...
describe('Calendar.vue', () => {
  it('create', async () => {
    ...
    const titleEl = wrapper.find('.hc-calendar__title')
    ...
    const rows = wrapper.element.querySelectorAll('.hc-calendar-table__row')
  ...
  it('range', () => {
    ...
    expect(
      wrapper.element.querySelector('.hc-calendar__button-group')
    ).toBeNull()
  })
  ...
  it('firstDayOfWeek', async () => {
    ...
    const head = wrapper.element.querySelector('.hc-calendar-table thead')
    expect(head?.firstElementChild?.innerHTML).toBe('Sun')
    expect(head?.lastElementChild?.innerHTML).toBe('Sat')
    const firstRow = wrapper.element.querySelector('.hc-calendar-table__row')
  ...
  it('click previous month or next month', async () => {
    ...
    await nextTick()
    const btns = wrapper.findAll('.hc-button')
  ...
  it('slots', async () => {
    ...
    expect(wrapper.find('.hc-calendar__header').text()).toEqual(AXIOM)
